...
[RequireComponent(typeof(ShotSystem), typeof(PistolStateMachine))]
public class PistolRecoilSystem : MonoBehaviour
{
    ...
    private PistolStateMachine _pistolStateMachine;
    private Vector3 recoilCurrent;


    private void Awake()
    {
        _pistolStateMachine = GetComponent<PistolStateMachine>();
    ...
    {
        shotTime = _pistolStateMachine.FireRate + 0.05f;
        returnValue = 0.1f;
        IsShooted = true;
    }
